...
// Persisted relay state. Plain booleans and timestamps live in
// SharedPreferences; URLs live in the platform's encrypted secure
// storage. The key names are short and generic so a prefs dump doesn't
// read as anything in particular.

/// Short prefix on every stored key. 3–5 ASCII chars ending in `_`.
const String _keyPrefix = 'ic7_';
...
class BeaconKeystore {
  ...
  Future<void> prime() async {
    ...
    // Drop any leftover disk slot from older builds. A push URL
    // must never survive into the next icon-launch.
