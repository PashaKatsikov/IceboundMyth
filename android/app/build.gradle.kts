...
// present. This lets the app build before Firebase credentials are
// supplied (the relay gate simply falls back to the native game).
...
android {
    ...
    compileOptions {
        // Required by flutter_local_notifications (java.time.*), pitfalls §5.
